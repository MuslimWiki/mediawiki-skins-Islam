...
/**
 * IslamComponentPageTools component
 * FIXME: Need unit test
 */
class IslamComponentPageTools implements IslamComponent {
	...
	private function shouldShowPageTools(): bool {
		$condition = $this->config->get( 'IslamShowPageTools' );
		$user = $this->user;
	...
	public function getTemplateData(): array {
		...
		return [
			...
			'msg-islam-share' => $this->localizer->msg( "islam-share" )->text()
		];
	}
}
