...
function adaptUserResult( apiUser ) {
	return {
		id: `islam-command-palette-item-user-${ apiUser.userid }`,
...
module.exports = {
	id: 'user',
	triggers: [ '/user:', '@' ],
	label: mw.message( 'islam-command-palette-command-user-label' ).text(),
	description: mw.message( 'islam-command-palette-command-user-description' ).text(),
