...
function adaptNamespaceResult( nsResult ) {
	return {
		id: `islam-command-palette-item-namespace-${ nsResult.value }`,
...
module.exports = {
	id: 'namespace',
	triggers: [ '/ns:', ':' ],
	label: mw.message( 'islam-command-palette-command-ns-label' ).text(),
	description: mw.message( 'islam-command-palette-command-ns-description' ).text(),
