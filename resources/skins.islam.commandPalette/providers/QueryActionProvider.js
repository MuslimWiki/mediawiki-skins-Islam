...
const queryActionDefinitions = [
	{
		id: 'fulltext-search',
		description: mw.message( 'islam-command-palette-queryaction-fulltext-search-description' ).text(),
	...
	{
		id: 'media-search',
		description: mw.message( 'islam-command-palette-queryaction-media-search-description' ).text(),
	...
	{
		id: 'page-edit',
		description: mw.message( 'islam-command-palette-queryaction-page-edit-description' ).text(),
		icon: cdxIconEdit,
	...
	getResults( query ) {
		...
		queryActionDefinitions.forEach( ( itemConfig ) => {
			if ( itemConfig.showItem ) {
				results.push( {
					id: `islam-command-palette-item-${ itemConfig.id }`,
					type: 'action',
					label: query,
