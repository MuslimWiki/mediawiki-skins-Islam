...
const RelatedArticlesProvider = {
	...
	label: mw.message( 'islam-command-palette-heading-related' ).text(),
		...
		fetchPromise = new Promise( ( resolve ) => {
			const onSuccess = async ( require ) => {
				try {
					...
					mw.log.error( '[skins.islam.commandPalette] RelatedArticlesProvider: Error inside mw.loader success callback:', error );
