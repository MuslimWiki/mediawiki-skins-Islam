...
const { IslamCommandPaletteSearchClient } = require( '../types.js' );
 ...
 *
 * @type {Object.<string, function(mw.Map): IslamCommandPaletteSearchClient>}
 */
 ...
 *
 * @return {IslamCommandPaletteSearchClient}
 ...
 * @param {function(mw.Map): IslamCommandPaletteSearchClient} factory Function that creates the search client instance.
