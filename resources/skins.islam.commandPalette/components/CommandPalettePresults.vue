<template>
	...
	<command-palette-list
		...
		:heading="$i18n( 'islam-command-palette-heading-related' ).text()"
	...
	<command-palette-list
		...
		:heading="$i18n( 'islam-command-palette-heading-recent' ).text()"
	...
	<command-palette-empty-state
		...
		:description="$i18n( 'islam-search-empty-desc' ).text()"
