...
<template>
	<section class="islam-command-palette-list">
		<div
			v-if="heading"
			class="islam-command-palette-list__heading"
		>
			{{ heading }}
		</div>
		<ul
			ref="listRef"
			class="islam-command-palette-list__listbox"
			role="listbox"
			tabindex="-1"
		>
...
.islam-command-palette-list {
	padding-block: var( --space-xs );

	&__heading {
		padding-block: var( --space-xs ) var( --space-xxs );
		padding-inline: var( --islam-command-palette-side-padding );
