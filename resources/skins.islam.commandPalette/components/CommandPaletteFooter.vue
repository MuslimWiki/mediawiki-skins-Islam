<template>
	<div class="islam-command-palette__footer">
		<!-- eslint-disable-next-line vue/no-v-html -->
		<div class="islam-command-palette__footer-note" v-html="currentTip"></div>
...
module.exports = exports = defineComponent( {
	...
	setup() {
		...
		const tips = [
			mw.message( 'islam-command-palette-tip-commands' ).parse(),
			mw.message( 'islam-command-palette-tip-users' ).parse(),
			mw.message( 'islam-command-palette-tip-namespace' ).parse(),
			mw.message( 'islam-command-palette-tip-templates' ).parse()
		];
