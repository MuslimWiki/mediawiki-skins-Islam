 ...
 * @property {string} type Type identifier (e.g., 'page', 'command', 'namespace', 'recent-item'). Used for styling and type labels via mw.message( `islam-command-palette-type-${type}` ).
...
/**
 * @typedef {Object} IslamCommandPaletteSearchClient
