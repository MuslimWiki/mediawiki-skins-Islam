const
	STICKY_HEADER_ID = 'islam-sticky-header',
	STICKY_HEADER_VISIBLE_CLASS = 'islam-sticky-header-visible';
...
function prepareMenuDropdown( menuDropdown ) {
	const
		...
		menuDropdownButton = menuDropdownClone.querySelector( '.islam-dropdown-summary' );
...
function getClickTarget( fakeButton ) {
	return document.querySelector( fakeButton.getAttribute( 'data-mw-islam-click-target' ) );
}
...
function handleClick( event ) {
	const fakeButton = event.target.closest( '.islam-sticky-header-fake-button' );
	if ( fakeButton ) {
...
function init( stickyHeader ) {
	const fakeButtons = stickyHeader.querySelectorAll( '.cdx-button[data-mw-islam-click-target]' );
	...
	fakeButtons.forEach( ( fakeButton ) => {
		...
		fakeButton.classList.add( 'islam-sticky-header-fake-button' );
	} );

	const
		moreMenuDropdown = document.getElementById( 'islam-page-more-dropdown' ),
		moreMenuDropdownContainer = document.getElementById( 'islam-sticky-header-more' ),
		languagesDropdown = document.getElementById( 'islam-page-languages-dropdown' ),
		languagesDropdownContainer = document.getElementById( 'islam-sticky-header-languages' );
