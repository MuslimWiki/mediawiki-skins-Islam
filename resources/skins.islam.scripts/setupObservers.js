...
const
	...
	SCROLL_DOWN_CLASS = 'islam-scroll--down',
	SCROLL_UP_CLASS = 'islam-scroll--up',
	PAGE_TITLE_INTERSECTION_CLASS = 'islam-below-page-title';
...
const main = () => {
	...
	const
		...
		stickyIntersection = document.getElementById( 'islam-page-header-sticky-sentinel' );
	...
	const resumeStickyHeader = () => {
		if (
			...
			if ( document.documentElement.classList.contains( 'islam-feature-autohide-navigation-clientpref-1' ) ) {
