...
const SECTION_CLASS = 'islam-toc-list-item';
const ACTIVE_SECTION_CLASS = 'islam-toc-list-item--active';
const EXPANDED_SECTION_CLASS = 'islam-toc-list-item--expanded';
const TOP_SECTION_CLASS = 'islam-toc-level-1';
const ACTIVE_TOP_SECTION_CLASS = 'islam-toc-level-1--active';
const LINK_CLASS = 'islam-toc-link';
const TOGGLE_CLASS = 'islam-toc-toggle';
 ...
 * @property {Section[]} array-sections
 * @property {boolean} islam-is-collapse-sections-enabled
 */
...
module.exports = function tableOfContents( props ) {
	...
	function bindPinnedToggleListeners() {
		const toggleButtons = document.querySelectorAll( '.islam-toc-pinnable-header button' );
	...
	function getTableOfContentsData( sections ) {
		...
		return {
			...
			'islam-is-collapse-sections-enabled': tableOfContentsLevel1Sections.length > 3 && sections.length >= tableOfContentsConfig.IslamTableOfContentsCollapseAtCount
		};
	}
	 ...
	 * IslamComponentTableOfContents::getTemplateData(),
	 * please make sure to keep them in sync.
	 *
	 * TODO: IslamComponentTableOfContents is not implemented as we need to support MW 1.39
	 *
	 * @param {Section[]} sections
