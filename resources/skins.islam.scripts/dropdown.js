 ...
 */
const
	DROPDOWN_CONTAINER_SELECTOR = '.islam-dropdown',
	DROPDOWN_DETAILS_SELECTOR = '.islam-dropdown-details',
	DROPDOWN_SUMMARY_SELECTOR = '.islam-dropdown-summary',
	DROPDOWN_TARGET_SELECTOR = '.islam-menu__card';
...
class Dropdown {
	...
	addKeyhint() {
		...
		links.forEach( ( link ) => {
			...
			keyhint.classList.add( 'islam-keyboard-hint-key' );
